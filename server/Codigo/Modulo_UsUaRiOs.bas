    ...
    With UserList(UserIndex)
        ...
        If InMapBounds(Map, X, Y) Then
            ...
            If Not toMap Then
                ...
                If Modalidad = eModalidad.Deathmatch Then NickColor = 99
                
                If Modalidad = eModalidad.Team Then
                   NickColor = IIf(.bando <> eBandos.ciuda, 101, 100)
                End If
...
'***************************************************
    ...
    With UserList(UserIndex)
        If .flags.UserLogged And Not .Counters.Saliendo Then
            ...
            .Counters.Salir = 1 'IIf((.flags.Privilegios And PlayerType.User) And MapInfo(.Pos.Map).Pk, IntervaloCerrarConexion, 0)
