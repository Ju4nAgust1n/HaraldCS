...
Public Const MAX_PUESTOS As Byte = 20

Public canRun As Byte

Public crimis As tRank
Public ciudas As tRank
Public death As tRank

Type tRank
     user(1 To 20) As String
     muertes(1 To 20) As String
End Type

Public curServerIP As String
Public curServerPort As Integer

Public lstServers(0 To max_Servers) As tManageLst
Type tManageLst
     name As String
     Ip   As String
     port As String
...
Public incomingData2 As clsByteQueue
Public outgoingData2 As clsByteQueue
