    ...
    For Y = minY To maxY
        ...
        For X = minX To maxX
            ...
            With MapData(X, Y)
                ...
                If .trampa > 0 Then
                    Call DDrawTransGrhtoSurface(grhTrampa, PixelOffsetXTemp + FxData(1).OffsetX, PixelOffsetYTemp, 1, 1)
                End If
            ...
            If .Head.Head(.Heading).GrhIndex Then
                ...
                If LenB(.Nombre) > 0 Then
                    If Nombres Then
                        ...
                        If .priv = 0 Then
                                If .death = 1 Then
                                    color = RGB(179, 200, 103)
                                ElseIf .death = 2 Then
                                    color = RGB(50, 93, 150)
                                Else
                                    color = RGB(204, 116, 46)
                                End If
                        Else
                                    color = vbGreen
                        End If
                        ...
                        If .priv <> 0 Then
                            ...
                            Call RenderTextCentered(PixelOffsetX + TilePixelWidth \ 2 + 5, PixelOffsetY + 45, "<GM>", color, frmMain.font)
                        End If
                    End If
                End If
            End If
